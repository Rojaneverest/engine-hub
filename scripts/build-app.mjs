...
const parts = ['app/prelude.js','app/ui.js','app/lab.js','app/discovery.js','app/engine-page.js','app/audio.js','app/bootstrap.js'].map(f=>fs.readFileSync(f,'utf8')).join('\n');
